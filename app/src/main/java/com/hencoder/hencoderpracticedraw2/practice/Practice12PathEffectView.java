...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setPathEffect(new DiscretePathEffect(30, 10));
        canvas.drawPath(path, paint);
        canvas.restore();
        ...
        paint.setPathEffect(new SumPathEffect(new DiscretePathEffect(30, 10),
                new DashPathEffect(new float[]{20, 10, 5, 10}, 5)));
        canvas.drawPath(path, paint);
        canvas.restore();
        ...
        paint.setPathEffect(new ComposePathEffect(new DashPathEffect(new float[]{20, 10, 5, 10}, 5),
